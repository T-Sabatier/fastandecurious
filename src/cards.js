export const DEFAULT_CARDS = [
  ...
  ['Coca', 'bouffe'], ['Orangina', 'bouffe'], ['Café noir', 'bouffe'],
  ['Thé vert', 'bouffe'], ['Croissant', 'bouffe'], ['Pain au choc', 'bouffe'],
  ['Tartare', 'bouffe'], ['Carpaccio', 'bouffe'], ['Frites', 'bouffe'],
  ['Patate douce', 'bouffe'], ['Glace vanille', 'bouffe'], ['Glace choco', 'bouffe'],
  ['Nutella', 'bouffe'], ['Camembert', 'bouffe'], ['Roquefort', 'bouffe'],
  ['Vin rouge', 'bouffe'], ['Vin blanc', 'bouffe'], ['Bière fraîche', 'bouffe'],
  ['Cocktail sucré', 'bouffe'], ['Ramen', 'bouffe'], ['Pho', 'bouffe'],
  ['Crêpe sucrée', 'bouffe'], ['Raclette', 'bouffe'], ['Fondue', 'bouffe'],
  ['Couscous', 'bouffe'], ['Tajine', 'bouffe'], ['Resto étoilé', 'bouffe'],
  ['McDo à 3h', 'bouffe'], ['Brunch', 'bouffe'], ['Burrata', 'bouffe'],
  ['Tiramisu', 'bouffe'], ['Crème brûlée', 'bouffe'], ['Champagne', 'bouffe'],
  ['Whisky', 'bouffe'],
